...
Route::GET('/home', 'SiteHomeController@index');
Route::GET('/produto/{id}/{nome}', 'SiteHomeController@produto')->name('produtos.index');
Route::GET('/blog/ajax', 'SiteHomeController@blog_ajax');
...
Route::GET('/catalogos', 'SiteHomeController@catalogos')->name('catalogos.site');
Route::GET('/blog/{id}/{name}', 'SiteHomeController@blog')->name('blog.site');
Route::GET('/contato', 'ContatoController@contato')->name('page_contato');
Route::POST('/enviar_contato_pag', 'ContatoController@paginaContato')->name('enviar_contato');
Route::GET('/orcamento', 'ContatoController@orcamento')->name('contato.orcamento');
Route::POST('/enviar_orcamento', 'ContatoController@enviarOrcamento')->name('enviar_orcamento');
Route::GET('/aovivo', 'SiteHomeController@aovivo')->name('page.aovivo');
Route::POST('/newsleatter/enviar', 'ContatoController@newsletter_enviar')->name('newsletter.enviar');
// Route::POST('/segmentos/ajax', 'SiteHomeController@segmentos_ajax');
// Route::GET('/segmento/{id}', 'SegmentosController@show');
